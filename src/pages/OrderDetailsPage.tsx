...
const OrderDetailsPage: React.FC = () => {
  ...
  // FIX: The error happens because order.items can be undefined.
  // This provides a fallback to `order_items` (the raw name from Supabase) 
  // and defaults to an empty array to prevent crashes.
  const orderItems: OrderItem[] = order.items || (order as any).order_items || [];
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div>
          ...
          <div className="space-y-4">
            ...
            )) : <p className="text-gray-500">This order has no items.</p>}
          </div>
        </div>
        <div>
