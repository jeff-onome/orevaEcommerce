...
const SocialShareButtons: React.FC<{ product: Product }> = ({ product }) => {
  ...
  const shareLinks = {
    ...
    pinterest: `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(pageUrl)}&media=${encodeURIComponent(product.imageUrl)}&description=${encodeURIComponent(shareText)}`,
